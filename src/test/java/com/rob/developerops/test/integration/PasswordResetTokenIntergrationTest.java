...
import com.rob.devoloperops.backend.persistence.repositories.PasswordResetTokenRepository;
...
//@SpringApplicationConfiguration(classes = developerops.class)
public class PasswordResetTokenIntergrationTest {
